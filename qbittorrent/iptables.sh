...
if [[ $iptable_mangle_exit_code == 0 ]]; then
	...
	grep -qF "8080    webui" /etc/iproute2/rt_tables || echo "8080    webui" >> /etc/iproute2/rt_tables
	grep -qF "8999    webui" /etc/iproute2/rt_tables || echo "8999    webui" >> /etc/iproute2/rt_tables
